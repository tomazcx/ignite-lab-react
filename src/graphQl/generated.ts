...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', title: string, id: string, availableAt?: any | null, slug: string, lessonType: LessonType }> };
